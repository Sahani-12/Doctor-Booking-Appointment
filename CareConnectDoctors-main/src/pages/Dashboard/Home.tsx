...
export default function Home() {
  return (
    <>
      <PageMeta
      title="CareConnect | Advanced Healthcare Management Dashboard"
      description="CareConnect is a comprehensive healthcare management dashboard designed for seamless medical administration, patient tracking, and hospital analytics."  
