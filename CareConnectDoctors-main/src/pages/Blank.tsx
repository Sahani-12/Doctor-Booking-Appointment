...
export default function Blank() {
  return (
    <div>
      <PageMeta
        title="CareConnect | Medical Dashboard"
        description="This is the CareConnect Medical Dashboard page for managing patient records, appointments, and healthcare analytics."
      />
